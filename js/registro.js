...
document.addEventListener("DOMContentLoaded", () => {
    const registroElement = document.querySelector(".contenido-registro");

    if (registroElement) {
        console.log("Registro cargado y listo.");
        // Lógica específica para el contenido de registro.php
    }
});